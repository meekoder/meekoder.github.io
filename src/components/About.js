      ...
      <div className="inner">
        <div>
          ...
          <StyledP className="text">
            <p>Hello! I'm Meeko.</p>
            <p>I'm a 24 year old software engineer based in the Southern California Area who has a strong passion for writing clean, efficient and performant code. I enjoy building reactive websites and applications that provide memorable user experiences.</p>
